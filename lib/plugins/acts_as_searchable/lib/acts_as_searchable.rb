    ...
    module Searchable
      ...
      module ClassMethods
        ...
        def acts_as_searchable(options = {})
          return if self.included_modules.include?(ZOGO::Acts::Searchable::InstanceMethods)
          ...
          send :include, ZOGO::Acts::Searchable::InstanceMethods
        end
      end
      ...
      module InstanceMethods
        ...
        module ClassMethods
          ...
          def search_token_match_statement(column, value='?')
            ZOGO::Database.like(column, value)
          end
