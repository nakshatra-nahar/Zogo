  ...
  module MenuManager
    ...
    module MenuController
      ...
      def redirect_to_project_menu_item(project, name)
        ...
        item = ZOGO::MenuManager.items(menu).detect {|i| i.name.to_s == name.to_s}
    ...
    module MenuHelper
      ...
      def display_main_menu?(project)
        ...
        menu_name.present? && ZOGO::MenuManager.items(menu_name).children.present?
      end
      ...
      def menu_items_for(menu, project=nil)
        items = []
        ZOGO::MenuManager.items(menu).root.children.each do |node|
    ...
    class Mapper
      ...
      #   eg. :children => Proc.new {|project| [ZOGO::MenuManager::MenuItem.new(...)] }
