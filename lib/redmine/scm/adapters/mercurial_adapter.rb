...
require 'zogo/scm/adapters/abstract_adapter'
require 'cgi'
  ...
  module Scm
    module Adapters
      class MercurialAdapter < AbstractAdapter
        ...
        HG_BIN = ZOGO::Configuration['scm_mercurial_command'] || "hg"
        HELPERS_DIR = File.dirname(__FILE__) + "/mercurial"
        HG_HELPER_EXT = "#{HELPERS_DIR}/zogohelper.py"
        ...
        class Revision < ZOGO::Scm::Adapters::Revision
        ...
        def hg(*args, &block)
          ...
          full_args << '--config' << "extensions.zogohelper=#{HG_HELPER_EXT}"
