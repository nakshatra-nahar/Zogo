  ...
  module Scm
    module Adapters
      ...
      class AbstractAdapter
        include ZOGO::Utils::Shell

        # raised if scm command exited with error, e.g. unknown revision.
        class ScmCommandAborted < ::ZOGO::Scm::Adapters::CommandFailed; end
        ...
        class << self
          ...
          def shell_quote(str)
            ZOGO::Utils::Shell.shell_quote str
          end

          def shell_quote_command
            ZOGO::Utils::Shell.shell_quote_command client_command
          end
        ...
        def self.stderr_log_file
          if @stderr_log_file.nil?
            writable = false
            path = ZOGO::Configuration['scm_stderr_log_file'].presence
      ...
      class Entry
        ...
        def is_text?
          ZOGO::MimeType.is_type?('text', name)
        end
        ...
        def author
          if changeset
            ...
            ZOGO::CodesetUtil.replace_invalid_utf8(lastrev.author.to_s.split('<').first)
          end
        end
      end
