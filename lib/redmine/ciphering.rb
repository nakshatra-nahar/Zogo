...
module ZOGO
  module Ciphering
    ...
    class << self
      ...
      def cipher_key
        key = ZOGO::Configuration['database_cipher_key'].to_s
    ...
    def read_ciphered_attribute(attribute)
      ZOGO::Ciphering.decrypt_text(read_attribute(attribute))
    end

    # Sets the value of the given ciphered attribute
    def write_ciphered_attribute(attribute, value)
      write_attribute(attribute, ZOGO::Ciphering.encrypt_text(value))
    end
  end
end
