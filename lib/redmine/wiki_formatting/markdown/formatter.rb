    ...
    module Markdown
      class HTML < Redcarpet::Render::HTML
        ...
        def block_code(code, language)
          if language.present? && ZOGO::SyntaxHighlighting.language_supported?(language)
            html = ZOGO::SyntaxHighlighting.highlight_by_language(code, language)
      ...
      class Formatter
        include ZOGO::WikiFormatting::LinksHelper
        alias :inline_restore_zogo_links :restore_zogo_links
        ...
        def to_html(*args)
          ...
          html = inline_restore_zogo_links(html)
          html
        end
        ...
        def update_section(index, update, hash=nil)
          ...
          if hash.present? && hash != Digest::MD5.hexdigest(t[1])
            raise ZOGO::WikiFormatting::StaleSectionError
          end
        ...
        def formatter
          @@formatter ||= Redcarpet::Markdown.new(
            ZOGO::WikiFormatting::Markdown::HTML.new(
              :filter_html => true,
              :hard_wrap => true
            ),
            :autolink => true,
