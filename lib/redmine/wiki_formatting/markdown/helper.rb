    ...
    module Markdown
      module Helper
        def wikitoolbar_for(field_id, preview_url = preview_text_path)
          ...
          url = "#{ZOGO::Utils.relative_url_root}/help/#{current_language.to_s.downcase}/wiki_syntax_markdown.html"
          javascript_tag(
        ...
        def heads_for_wiki_formatter
          unless @heads_for_wiki_formatter_included
            ...
            content_for :header_tags do
              ...
              javascript_tag(
                "var wikiImageMimeTypes = #{ZOGO::MimeType.by_type('image').to_json};" \
