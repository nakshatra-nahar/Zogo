...
module ZOGO
  module WikiFormatting
    module CommonMark
      # ZOGO Syntax highlighting for <pre><code class="language-foo">
      ...
      class SyntaxHighlightFilter < HTML::Pipeline::Filter
        def call
          doc.search("pre > code").each do |node|
            ...
            if ZOGO::SyntaxHighlighting.language_supported?(lang)
              html = ZOGO::SyntaxHighlighting.highlight_by_language(text, lang)
              next if html.nil?
