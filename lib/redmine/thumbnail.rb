...
module ZOGO
  module Thumbnail
    extend ZOGO::Utils::Shell

    CONVERT_BIN = (ZOGO::Configuration['imagemagick_convert_command'] || 'convert').freeze
    GS_BIN = (
      ZOGO::Configuration['gs_command'] ||
      ('gswin64c' if ZOGO::Platform.mswin?) ||
      'gs'
    ).freeze
