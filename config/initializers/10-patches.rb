...
module ActiveRecord
  class Base
    ...
    def self.human_attribute_name(attr, options = {})
      ...
      options[:default] = zogo_default + Array(options[:default])
  ...
  # See Defect #11545 (http://www.zogo.org/issues/11545) for details.
  class Base
    class << self
      undef open
    end
...
module ActionController
  class Base
    ...
    # when trying to start ZOGO with an old session_store.rb
