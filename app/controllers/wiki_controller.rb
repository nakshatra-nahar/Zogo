...
class WikiController < ApplicationController
  ...
  def show
    ...
    @sections_editable = @editable && User.current.allowed_to?(:edit_wiki_pages, @page.project) &&
      ...
      ZOGO::WikiFormatting.supports_section_edit?
  ...
  def edit
    ...
    @text = @content.text
    if params[:section].present? && ZOGO::WikiFormatting.supports_section_edit?
      @section = params[:section].to_i
      @text, @section_hash = ZOGO::WikiFormatting.formatter.new(@text).get_section(@section)
  ...
  def update
    ...
    if params[:section].present? && ZOGO::WikiFormatting.supports_section_edit?
      ...
      @content.text = ZOGO::WikiFormatting.formatter.new(@content.text).update_section(@section, @text, @section_hash)
    else
  ...
  rescue ActiveRecord::StaleObjectError, ZOGO::WikiFormatting::StaleSectionError
