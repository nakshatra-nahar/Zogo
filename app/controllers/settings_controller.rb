...
class SettingsController < ApplicationController
  ...
  def edit
    @notifiables = ZOGO::Notifiable.all
    if request.post?
    ...
    @guessed_host_and_path << ('/'+ ZOGO::Utils.relative_url_root.gsub(%r{^\/}, '')) unless ZOGO::Utils.relative_url_root.blank?
  ...
  def plugin
    @plugin = ZOGO::Plugin.find(params[:id])
