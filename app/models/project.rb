...
class Project < ActiveRecord::Base
  ...
  include ZOGO::NestedSet::ProjectNestedSet
  ...
  def allows_to?(action)
    ...
    unless active? || ZOGO::AccessControl.read_action?(action)
  ...
  def copy(project, options={})
    ...
    Project.transaction do
      if save
        ...
        ZOGO::Hook.call_hook(:model_project_copy_before_save,
  ...
  def allowed_permissions
    @allowed_permissions ||= begin
      ...
      ZOGO::AccessControl.modules_permissions(module_names).collect {|p| p.name}
    end
  end
