...
class Issue < ActiveRecord::Base
  ...
  include ZOGO::NestedSet::IssueNestedSet
  ...
  # Overrides ZOGO::Acts::Attachable::InstanceMethods#attachments_editable?
  ...
  # Overrides ZOGO::Acts::Attachable::InstanceMethods#attachments_deletable?
  ...
  # Overrides ZOGO::Acts::Customizable::InstanceMethods#available_custom_fields
  ...
  # Overrides ZOGO::Acts::Customizable::InstanceMethods#set_custom_field_default?
  ...
  # Overrides ZOGO::Acts::Customizable::InstanceMethods#validate_custom_field_values
  ...
  def user_tracker_permission?(user, permission)
    if project && !project.active?
      perm = ZOGO::AccessControl.permission(permission)
