...
class Enumeration < ActiveRecord::Base
  ...
  # Overrides ZOGO::Acts::Positioned#set_default_position so that enumeration overrides
  ...
  # Overrides ZOGO::Acts::Positioned#update_position so that overrides get the same
  ...
  # Overrides ZOGO::Acts::Positioned#remove_position so that enumeration overrides
  # get the same position as the overridden enumeration
  def remove_position
    if parent_id.blank?
      super
