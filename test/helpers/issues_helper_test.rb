...
class IssuesHelperTest < ZOGO::HelperTest
  ...
  test 'show_detail should show old and new values with a assigned to attribute' do
    detail = JournalDetail.new(:property => 'attr', :prop_key => 'assigned_to_id',
                               :old_value => 1, :value => 2)
    assert_match 'ZOGO Admin', show_detail(detail, true)
  ...
  def test_details_to_strings_with_multiple_values_removed_from_custom_field
    ...
    assert_equal ["User deleted (Dave Lopper, ZOGO Admin)"], details_to_strings(details, true)
    assert_equal ["<strong>User</strong> deleted (<del><i>Dave Lopper, ZOGO Admin</i></del>)"], details_to_strings(details, false)
  end
  ...
  def test_details_to_strings_with_multiple_values_added_to_custom_field
    ...
    assert_equal ["User Dave Lopper, ZOGO Admin added"], details_to_strings(details, true)
    assert_equal ["<strong>User</strong> <i>Dave Lopper, ZOGO Admin</i> added"], details_to_strings(details, false)
  end
  ...
  def test_details_to_strings_with_multiple_values_added_and_removed_from_custom_field
    ...
    assert_equal(
      [
        "<strong>User</strong> <i>ZOGO Admin</i> added",
