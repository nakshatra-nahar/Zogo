...
class GitAdapterTest < ActiveSupport::TestCase
  ...
  ## ZOGO Mercurial adapter and extension use URL encoding.
  ...
  if File.directory?(REPOSITORY_PATH)
    ...
    WINDOWS_PASS = (ZOGO::Platform.mswin? &&
                    ZOGO::Scm::Adapters::GitAdapter.client_version_above?([1, 7, 10]))
    WINDOWS_SKIP_STR = "TODO: This test fails in Git for Windows above 1.7.10"

    def setup
      adapter_class = ZOGO::Scm::Adapters::GitAdapter
    ...
    def test_default_branch
      ...
      b_foo, b_bar, b_main, b_master =
        %w[foo bar main master].map do |name|
          ZOGO::Scm::Adapters::GitAdapter::GitBranch.new(name)
        end
    ...
    def test_revisions_invalid_rev
      ...
      assert_raise ZOGO::Scm::Adapters::CommandFailed do
        revs1 = []
        @adapter.revisions(
          '',
          '1234abcd',
    ...
    def test_annotate
      ...
      assert_kind_of ZOGO::Scm::Adapters::Annotate, annotate
    ...
    def test_path_encoding_default_utf8
      adpt1 =
        ZOGO::Scm::Adapters::GitAdapter.new(
          REPOSITORY_PATH
        )
