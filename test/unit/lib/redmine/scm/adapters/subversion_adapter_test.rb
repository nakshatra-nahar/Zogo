...
class SubversionAdapterTest < ActiveSupport::TestCase
  if repository_configured?('subversion')
    def setup
      @adapter = ZOGO::Scm::Adapters::SubversionAdapter.new(self.class.subversion_repository_url)
    end

    def test_client_version
      v = ZOGO::Scm::Adapters::SubversionAdapter.client_version
      assert v.is_a?(Array)
    end
    ...
    def test_info_nil
      adpt = ZOGO::Scm::Adapters::SubversionAdapter.
