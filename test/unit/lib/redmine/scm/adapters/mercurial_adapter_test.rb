...
class MercurialAdapterTest < ActiveSupport::TestCase
  HELPERS_DIR        = ZOGO::Scm::Adapters::MercurialAdapter::HELPERS_DIR
  TEMPLATE_NAME      = ZOGO::Scm::Adapters::MercurialAdapter::TEMPLATE_NAME
  TEMPLATE_EXTENSION = ZOGO::Scm::Adapters::MercurialAdapter::TEMPLATE_EXTENSION
  HgCommandAborted   = ZOGO::Scm::Adapters::MercurialAdapter::HgCommandAborted
  HgCommandArgumentError = ZOGO::Scm::Adapters::MercurialAdapter::HgCommandArgumentError

  REPOSITORY_PATH = repository_path('mercurial')

  if File.directory?(REPOSITORY_PATH)
    def setup
      adapter_class = ZOGO::Scm::Adapters::MercurialAdapter
      ...
      @adapter =
        ZOGO::Scm::Adapters::MercurialAdapter.new(
          REPOSITORY_PATH,
          nil,
          nil,
          nil,
    ...
    def test_info
      [REPOSITORY_PATH, REPOSITORY_PATH + "/",
       REPOSITORY_PATH + "//"].each do |repo|
        adp = ZOGO::Scm::Adapters::MercurialAdapter.new(repo)
