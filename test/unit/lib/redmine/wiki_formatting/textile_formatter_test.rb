...
class ZOGO::WikiFormatting::TextileFormatterTest < ActionView::TestCase
  def setup
    @formatter = ZOGO::WikiFormatting::Textile::Formatter
  end
  ...
  def test_inline_code
    assert_html_output(
      ...
      '@<Location /zogo>@'    => '<code>&lt;Location /zogo&gt;</code>'
    )
  end
  ...
  def test_update_section_with_wrong_hash_should_raise_an_error
    assert_raise ZOGO::WikiFormatting::StaleSectionError do
