...
if Object.const_defined?(:CommonMarker)
  require 'zogo/wiki_formatting/common_mark/sanitization_filter'

  class ZOGO::WikiFormatting::CommonMark::SanitizationFilterTest < ActiveSupport::TestCase
    def filter(html)
      ZOGO::WikiFormatting::CommonMark::SanitizationFilter.to_html(html, @options)
    end
