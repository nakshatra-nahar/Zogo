...
if Object.const_defined?(:CommonMarker)
  require 'zogo/wiki_formatting/common_mark/syntax_highlight_filter'

  class ZOGO::WikiFormatting::CommonMark::SyntaxHighlightFilterTest < ActiveSupport::TestCase
    def filter(html)
      ZOGO::WikiFormatting::CommonMark::SyntaxHighlightFilter.to_html(html, @options)
    end
