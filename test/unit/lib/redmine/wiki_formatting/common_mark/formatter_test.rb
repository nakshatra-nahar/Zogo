...
class ZOGO::WikiFormatting::CommonMark::FormatterTest < ActionView::TestCase
  if Object.const_defined?(:CommonMarker)

    def setup
      @formatter = ZOGO::WikiFormatting::CommonMark::Formatter
    end
    ...
    def test_zogo_links_with_double_quotes_should_be_preserved
      text = 'This is a zogo link: version:"1.0"'
  ...
  * Two
    ...
    def test_should_autolink_urls_and_emails
      [
        ...
        ["http://www.zogo.org/projects/zogo/issues?utf8=✓",
         '<p><a href="http://www.zogo.org/projects/zogo/issues?utf8=%E2%9C%93" class="external">http://www.zogo.org/projects/zogo/issues?utf8=✓</a></p>'],
