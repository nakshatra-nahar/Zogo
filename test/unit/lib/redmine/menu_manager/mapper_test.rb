...
class ZOGO::MenuManager::MapperTest < ActiveSupport::TestCase
  test "Mapper#initialize should define a root MenuNode if menu is not present in items" do
    menu_mapper = ZOGO::MenuManager::Mapper.new(:test_menu, {})
  ...
  test "Mapper#initialize should use existing MenuNode if present" do
    ...
    menu_mapper = ZOGO::MenuManager::Mapper.new(:test_menu, {:test_menu => node})
  ...
  test 'deleting all items' do
    ...
    ZOGO::MenuManager.map :test_menu do |menu|
      menu.push :not_last, ZOGO::Info.help_url
      menu.push :administration, {:controller => 'projects', :action => 'show'}, {:last => true}
      menu.push :help, ZOGO::Info.help_url, :last => true
    end
