...
class ZOGO::Views::Builders::XmlTest < ActiveSupport::TestCase
  def test_hash
  ...
  def assert_xml_output(expected, &block)
    builder = ZOGO::Views::Builders::Xml.new(ActionDispatch::TestRequest.create, ActionDispatch::TestResponse.create)
    yield(builder)
