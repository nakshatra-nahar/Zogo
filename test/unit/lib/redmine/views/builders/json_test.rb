...
class ZOGO::Views::Builders::JsonTest < ActiveSupport::TestCase
  ...
  def assert_json_output(expected, &block)
    builder = ZOGO::Views::Builders::Json.new(ActionDispatch::TestRequest.create, ActionDispatch::TestResponse.create)
    yield(builder)
