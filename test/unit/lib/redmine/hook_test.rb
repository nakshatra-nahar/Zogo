...
class ZOGO::Hook::ManagerTest < ActionView::TestCase
  ...
  class TestHook < ZOGO::Hook::ViewListener; end
  ...
  # Context: ZOGO::Hook::Helper.call_hook default_url
  ...
  # Context: ZOGO::Hook::Helper.call_hook
