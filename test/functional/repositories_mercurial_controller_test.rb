...
class RepositoriesMercurialControllerTest < ZOGO::RepositoryControllerTest
    ...
    def test_revision
      ...
      ['1', '9d5b5b', '9d5b5b004199'].each do |r|
        with_settings :default_language => "en" do
          ...
          assert_response :success
          assert_select 'title',
                        :text => 'Revision 1:9d5b5b004199 - Added 2 files and modified one. - eCookbook Subproject 1 - ZOGO'
        end
      end
    end
