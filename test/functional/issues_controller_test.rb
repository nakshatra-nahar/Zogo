...
class IssuesControllerTest < ZOGO::ControllerTest
  fixtures :projects,
  ...
  def test_index_with_last_notes_column
    with_settings :text_formatting => 'textile' do
      ...
      assert_select 'td.last_notes[colspan="4"]', :text => 'Some notes with ZOGO links: #2, r2.'
      assert_select(
  ...
  def test_show_by_anonymous
    ...
    assert_select 'title', :text => "Bug #1: Cannot print recipes - eCookbook - ZOGO"
  end
