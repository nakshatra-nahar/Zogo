...
class WikiControllerTest < ZOGO::ControllerTest
  ...
  def test_edit_section
    with_settings :text_formatting => 'textile' do
      ...
      section, hash = ZOGO::WikiFormatting::Textile::Formatter.new(page.content.text).get_section(2)
  ...
  def test_update_section
    with_settings :text_formatting => 'textile' do
      ...
      assert_equal ZOGO::WikiFormatting::Textile::Formatter.new(text).update_section(2, 'New section content'), page.reload.content.text
    end
  end
  ...
  def test_update_section_should_allow_stale_page_update
    with_settings :text_formatting => 'textile' do
      ...
      assert_redirected_to '/projects/ecookbook/wiki/Page_with_sections#section-2'
      page.reload
      assert_equal ZOGO::WikiFormatting::Textile::Formatter.new(text).update_section(2, 'New section content'), page.content.text
  ...
  def test_annotate
    ...
    assert_select 'table.annotate tr:nth-child(1)' do
      ...
      assert_select 'td.author', :text => /ZOGO Admin/
