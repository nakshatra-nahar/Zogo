...
class AccountControllerTest < ZOGO::ControllerTest
  ...
  def test_login_with_suburi_should_redirect_to_back_url_param
    ...
    ZOGO::Utils.relative_url_root = '/zogo'

    back_urls = [
      'http://test.host/zogo/issues/show/1',
      '/zogo'
    ]
    back_urls.each do |back_url|
      post(
  ...
  def test_login_with_suburi_should_not_redirect_to_another_suburi
    ...
    back_urls = [
      ...
      'http://test.host/zogo/../fake',
      'http://test.host/zogo/../fake/issues',
      'http://test.host/zogo/%2e%2e/fake',
      '//test.foo/fake',
      'http://test.host//fake',
      'http://test.host/\n//fake',
      '//bar@test.foo',
